...
calculate.gradedareas <- function(arg1, arg2, arg3, numpts) .Call("rcpp_calculate_graded_areas", arg1, arg2, arg3, rnorm(numpts, 0, 1), rnorm(numpts,0,1), PACKAGE="SocialNetworks")