#(size n.three way nested. model 3 c)
# Section 3.4.2.2 test factor C in B in A
...
size_n.three_way_nested.model_3_c <-  function(alpha, beta, delta, a, b, c, cases)
{
	n <- 2
	dfn <- a*b*(c-1)
	dfd <- a*b*c*(n-1)
...
# example
# size.3_4_2_2.test_factor_CinBinA(0.05, 0.1, 0.5, 6, 5, 4, "maximin")
# size.3_4_2_2.test_factor_CinBinA(0.05, 0.1, 0.5, 6, 5, 4, "minimin")
