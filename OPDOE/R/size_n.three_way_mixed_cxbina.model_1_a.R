#(size n.three way mixed cx(bina). model 1 a)
# Section 3.4.4.1 test factor A
...
size_n.three_way_mixed_cxbina.model_1_a <-  function(alpha, beta, delta, a, b, c, cases)
{
	n <- 2
	dfn <- (a-1)
	dfd <- a*b*c*(n-1)
...
# example
# size.3_4_4_1.test_factor_A(0.05, 0.1, 0.5, 6, 5, 4, "maximin")
# size.3_4_4_1.test_factor_A(0.05, 0.1, 0.5, 6, 5, 4, "minimin")
