#(size n.three way nested. model 8 c)
# Section 3.4.2.7 test factor C

# Three way nested classification. Model VIII
# Factor C is fixed, A and B are random. Determining n
# a, b, and c are given. Testing hypothesis about factor C in B in A
size_n.three_way_nested.model_8_c <-  function(alpha, beta, delta, a, b, c, cases)
{
	n <- 2
	dfn <- a*b*(c-1)
	dfd <- a*b*c*(n-1)
...
# example
# size.3_4_2_7.test_factor_C(0.05, 0.1, 0.5, 6, 5, 4, "maximin")
# size.3_4_2_7.test_factor_C(0.05, 0.1, 0.5, 6, 5, 4, "minimin")
