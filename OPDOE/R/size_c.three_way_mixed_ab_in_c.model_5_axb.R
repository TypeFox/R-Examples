#(size c.three way mixed ab in c. model 5 axb)
# Section 3.4.3.4 test interaction AxB
...
size_c.three_way_mixed_ab_in_c.model_5_axb <-  function(alpha, beta, delta, a, b, n, cases)
{
	c <- 5    
	c.new <- 1000
...
# example
# size.3_4_3_4.test_factor_AB(0.05, 0.1, 0.5, 6, 5, 1, "maximin")
# size.3_4_3_4.test_factor_AB(0.05, 0.1, 0.5, 6, 5, 1, "minimin")
