#(size n.three way mixed ab in c. model 3 c)
# section 3.4.3.2 test factor C in AxB
...
size_n.three_way_mixed_ab_in_c.model_3_c <-  function(alpha, beta, delta, a, b, c, cases)
{
	n <- 2
	dfn <- a*b*(c-1)
	dfd <- a*b*c*(n-1)
...
# example
# size.3_4_3_2.test_factor_C(0.05, 0.1, 0.5, 6, 5, 4, "maximin")
# size.3_4_3_2.test_factor_C(0.05, 0.1, 0.5, 6, 5, 4, "minimin")
