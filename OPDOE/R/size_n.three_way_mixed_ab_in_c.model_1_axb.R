#(size n.three way mixed ab in c. model 1 axb)
# Section 3.4.3.1 test interaction AxB 

# Three way mixed classification. (AxB)>C, Model I
# Factor A, B, C are fixed. Determining n
# a, b, and c are given. Testing hypothesis Interacion AxB is not present
size_n.three_way_mixed_ab_in_c.model_1_axb <-  function(alpha, beta, delta, a, b, c, cases)
{
	n <- 2
	dfn <- (a-1)*(b-1)
	dfd <- a*b*c*(n-1)
...
# example
# size.3_4_3_1.test_interaction_AB(0.05, 0.1, 0.5, 6, 5, 4, "maximin")
# size.3_4_3_1.test_interaction_AB(0.05, 0.1, 0.5, 6, 5, 4, "minimin")
