#(size n.three way cross.model 1 axb)
# Section 3.4.1.1 test Interaction AxB
...
# Hypothesis: Interaction AxB is not present. 
size_n.three_way_cross.model_1_axb <-  function(alpha, beta, delta, a, b, c, cases)
{
	n <- 2
	dfn <- (a-1)*(b-1)
	dfd <- a*b*c*(n-1)
...
# example
# size.3_4_1_1.interaction.ab(0.05, 0.1, 0.5, 6,5,4, "maximin")
# size.3_4_1_1.interaction.ab(0.05, 0.1, 0.5, 6,5,4, "minimin")
