#(size n.two way nested. model 1 test factor b)
# Section 3.3.2.1  test factor B

# Two way nested classification A>B
# A fixed, B fixed. determine n. 
# a and b are given. Test factor B has no effects.
size_n.two_way_nested.model_1_test_factor_b <-  function(alpha, beta, delta, a, b, cases)
{
	n <- 2
	dfn <- a*(b-1)
	dfd <- a*b*(n-1)
...
# example
# size.3_3_2_1_B(0.05, 0.1, 1, 6, 4, "maximin")
# size.3_3_2_1_B(0.05, 0.1, 1, 6, 4, "minimin")
