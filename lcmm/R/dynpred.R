            ...
            if(!isTRUE(draws))
                {
                    ...
                    out <- .Fortran("postprob2_comp",as.double(Y),as.double(X),
                                    as.integer(ns),as.integer(nmes),as.integer(nobs),
                                    as.integer(ng),as.integer(nv),as.integer(idiag),
                                    as.integer(nwg),as.integer(ncor),
                                    as.integer(logspecif),
                                    as.double(zi),as.integer(idea),as.integer(idg),
                                    as.integer(idprob),as.integer(idcor),
                                    as.integer(idcom),as.integer(idspecif2),
                                    as.integer(idtdv),as.integer(risqcom),
                                    as.integer(nvdepsurv),as.integer(typrisq),
                                    as.integer(nz),as.integer(nprisq),
                                    as.integer(nbzitr),as.double(zitr),
                                    as.integer(idlink),as.integer(indiceY),
                                    as.double(uniqueY),as.integer(nvalSPL),
                                    as.double(epsY),as.integer(nbevt),
                                    as.double(tsurv0),as.integer(idtrunc),
                                    as.double(best),as.integer(npm),
                                    as.double(timemes),as.double(landmark),
                                    as.integer(nbland),ppi=as.double(ppi),
                                    PACKAGE="lcmm")
                    ...
                    doOneDraw <- function()
                        {
                            ...
                            out <- .Fortran("postprob2_comp",as.double(Y),as.double(X),
                                            ...
                                            as.integer(ng),as.integer(nv),as.integer(idiag),
                                            as.integer(nwg),as.integer(ncor),
                                            as.integer(logspecif),as.double(zi),
                                            as.integer(idea),as.integer(idg),
                                            as.integer(idprob),as.integer(idcor),
                                            as.integer(idcom),as.integer(idspecif2),
                                            as.integer(idtdv),as.integer(risqcom),
                                            as.integer(nvdepsurv),as.integer(typrisq),
                                            ...
                                            as.double(epsY),as.integer(nbevt),
                                            as.double(tsurv0),as.integer(idtrunc),
                                            as.double(bdraw),as.integer(npm),
                                            as.double(timemes),as.double(landmark),
                                            as.integer(nbland),ppi=as.double(ppi),
                                            PACKAGE="lcmm") 
