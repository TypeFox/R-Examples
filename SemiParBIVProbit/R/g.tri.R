...
p.1.00  <- mm(pbinorm(-TIn$eta2,  -TIn$eta3, mean1 =  -mean1, mean2 =  -mean2, var1 = var1, var2 = var2, cov12 =   cov1) ) 
p.1.01  <- mm(pbinorm(-TIn$eta2,   TIn$eta3, mean1 =  -mean1, mean2 =   mean2, var1 = var1, var2 = var2, cov12 =  -cov1) )
...
p.2.00  <- mm(pbinorm(-TIn$eta1,  -TIn$eta3, mean1 =  -mean3, mean2 =  -mean4, var1 = var1, var2 = var3, cov12 =   cov2) )
p.2.01  <- mm(pbinorm(-TIn$eta1,   TIn$eta3, mean1 =  -mean3, mean2 =   mean4, var1 = var1, var2 = var3, cov12 =  -cov2) )
...
p.3.00  <- mm(pbinorm(-TIn$eta1,  -TIn$eta2, mean1 =  -mean5, mean2 =  -mean6, var1 = var2, var2 = var3, cov12 =   cov3) ) 
p.3.01  <- mm(pbinorm(-TIn$eta1,   TIn$eta2, mean1 =  -mean5, mean2 =   mean6, var1 = var2, var2 = var3, cov12 =  -cov3) ) 

dl.de1 <- respvec$y1.y2.y3/TIn$p111 * d.1 * p.1.11 +
...
dl.de2 <- respvec$y1.y2.y3/TIn$p111 * d.2 * p.2.11 + 
...
dl.de3 <-  respvec$y1.y2.y3/TIn$p111 * d.3 * p.3.11 -
