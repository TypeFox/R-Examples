...
H.triSS <- function(params, respvec, VC, TIn, LgTRI){
  ...
  d2l.de1.e1 <- respvec$cy1 * ( -1/TIn$p0^2 * (d.1)^2 + 1/TIn$p0 * (TIn$eta1 * d.1) ) +
    respvec$y1.cy2    * ( -1/TIn$p10^2  * (d.1 - d.1 * LgTRI$upst.1)^2 + 1/TIn$p10  * ( - TIn$eta1 * d.1 + TIn$eta1 * d.1 * LgTRI$upst.1 - d.1 * dst.1 * st.1) ) +
    respvec$y1.y2.cy3 * ( -1/TIn$p110^2 * (d.1 * LgTRI$p.1.10)^2   + 1/TIn$p110 * ( -TIn$eta1 * d.1 * LgTRI$p.1.10   + d.1 * dp.1.10.de1)  ) +
    respvec$y1.y2.y3  * ( -1/TIn$p111^2 * (d.1 * LgTRI$p.1.11)^2   + 1/TIn$p111 * ( -TIn$eta1 * d.1 * LgTRI$p.1.11   + d.1 * dp.1.11.de1)  ) 
  
  
  d2l.de2.e2 <- respvec$y1.cy2 * ( -1/TIn$p10^2  * ( - d.2 * LgTRI$upst.2)^2 + 1/TIn$p10  * ( TIn$eta2 * d.2 * LgTRI$upst.2 - d.2 * dst.3 * st.3) ) + 
    respvec$y1.y2.cy3 * ( -1/TIn$p110^2 * (d.2 * LgTRI$p.2.10)^2 + 1/TIn$p110 * ( -TIn$eta2  * d.2 * LgTRI$p.2.10 + d.2 * dp.2.10.de2) ) +
    respvec$y1.y2.y3  * ( -1/TIn$p111^2 * (d.2 * LgTRI$p.2.11)^2 + 1/TIn$p111 * ( -TIn$eta2  * d.2 * LgTRI$p.2.11 + d.2 * dp.2.11.de2) ) 
  ...
  d2l.de1.e2 <- respvec$y1.cy2 * ( -1/TIn$p10^2  * (d.1 - d.1 * LgTRI$upst.1) * ( - d.2 * LgTRI$upst.2) - 1/TIn$p10 * d.2 * dst.3 * 1/sqrt(1 - TIn$theta12^2)) + 
    respvec$y1.y2.cy3 * ( -1/TIn$p110^2 * d.2 * LgTRI$p.2.10 * d.1 * LgTRI$p.1.10 + 1/TIn$p110 * d.2 * d.1.1 * p1.c ) + 
    respvec$y1.y2.y3  * ( -1/TIn$p111^2 * d.2 * LgTRI$p.2.11 * d.1 * LgTRI$p.1.11 + 1/TIn$p111 * d.2 * d.1.1 * p1   )
  
  d2l.de1.e3 <- - respvec$y1.y2.cy3 * ( -1/TIn$p110^2 * d.3 * LgTRI$p.3.11 * d.1 * LgTRI$p.1.10 + 1/TIn$p110 * d.3 * d.1.2 * p2   ) + 
    respvec$y1.y2.y3 * ( -1/TIn$p111^2 * d.3 * LgTRI$p.3.11 * d.1 * LgTRI$p.1.11 + 1/TIn$p111 * d.3 * d.1.2 * p2   )
   
    
  d2l.de2.e3 <- - respvec$y1.y2.cy3 * ( -1/TIn$p110^2 * d.3 * LgTRI$p.3.11 * d.2 * LgTRI$p.2.10 + 1/TIn$p110 * d.3 * d.1.3 * p3   ) + 
    respvec$y1.y2.y3 * ( -1/TIn$p111^2 * d.3 * LgTRI$p.3.11 * d.2 * LgTRI$p.2.11 + 1/TIn$p111 * d.3 * d.1.3 * p3   ) 
  ...
  d2l.de1.theta12 <- respvec$y1.cy2 * ( -1/TIn$p10^2 * (d.1 - d.1 * LgTRI$upst.1) * ( - LgTRI$d11.12) + 1/TIn$p10 * LgTRI$d11.12 * (TIn$eta1 - TIn$theta12 * TIn$eta2)/(1 - TIn$theta12^2) ) +
    ...
    respvec$y1.y2.y3  * ( -1/TIn$p111^2 * d.1 * LgTRI$p.1.11 * LgTRI$d11.12 * LgTRI$p12.g   + 1/TIn$p111 * ( LgTRI$d11.12 * (TIn$theta12*TIn$eta2  - TIn$eta1)/(1 - TIn$theta12^2) * LgTRI$p12.g   - LgTRI$d11.12 * d12/LgTRI$sd.12 * ((TIn$theta13 - TIn$theta12 * TIn$theta23)/(1 - TIn$theta12^2)) )) 
  
  d2l.de1.theta13 <- - respvec$y1.y2.cy3   * ( -1/TIn$p110^2 * d.1 * LgTRI$p.1.10 * LgTRI$d11.13 * LgTRI$p13.g   + 1/TIn$p110 * ( LgTRI$d11.13 * (TIn$theta13 * TIn$eta3 - TIn$eta1)/(1 - TIn$theta13^2) * LgTRI$p13.g   - LgTRI$d11.13 * d13/LgTRI$sd.13 * ((TIn$theta12 - TIn$theta13 * TIn$theta23)/(1 - TIn$theta13^2)) )) +
    respvec$y1.y2.y3 * ( -1/TIn$p111^2 * d.1 * LgTRI$p.1.11 * LgTRI$d11.13 * LgTRI$p13.g   + 1/TIn$p111 * ( LgTRI$d11.13 * (TIn$theta13 * TIn$eta3 - TIn$eta1)/(1 - TIn$theta13^2) * LgTRI$p13.g   - LgTRI$d11.13 * d13/LgTRI$sd.13 * ((TIn$theta12 - TIn$theta13 * TIn$theta23)/(1 - TIn$theta13^2)) )) 
    
  d2l.de1.theta23 <- - respvec$y1.y2.cy3  * ( -1/TIn$p110^2 * d.1 * LgTRI$p.1.10 * LgTRI$d11.23 * LgTRI$p23.g   + 1/TIn$p110 * LgTRI$d11.23 * d23/LgTRI$sd.23 ) +
    respvec$y1.y2.y3 * ( -1/TIn$p111^2 * d.1 * LgTRI$p.1.11 * LgTRI$d11.23 * LgTRI$p23.g   + 1/TIn$p111 * LgTRI$d11.23 * d23/LgTRI$sd.23) 
    
  d2l.de2.theta12 <- respvec$y1.cy2 * ( -1/TIn$p10^2 * d.2 *  LgTRI$upst.2 * LgTRI$d11.12 - 1/TIn$p10  * LgTRI$d11.12  * (TIn$theta12 * TIn$eta1 - TIn$eta2)/(1 - TIn$theta12^2) ) +
    ...
    respvec$y1.y2.y3  * ( -1/TIn$p111^2 * d.2 * LgTRI$p.2.11 * LgTRI$d11.12 * LgTRI$p12.g   + 1/TIn$p111 * (LgTRI$d11.12 * (TIn$theta12 * TIn$eta1 - TIn$eta2)/(1 - TIn$theta12^2) * LgTRI$p12.g   - LgTRI$d11.12 * (d12/LgTRI$sd.12) * (TIn$theta23 - TIn$theta12 * TIn$theta13)/(1 - TIn$theta12^2) ) ) 
  
  d2l.de2.theta13 <- - respvec$y1.y2.cy3 * ( -1/TIn$p110^2 * d.2 * LgTRI$p.2.10 * LgTRI$d11.13 * LgTRI$p13.g   + 1/TIn$p110 * LgTRI$d11.13 * d13/LgTRI$sd.13 ) + 
    respvec$y1.y2.y3 * ( -1/TIn$p111^2 * d.2 * LgTRI$p.2.11 * LgTRI$d11.13 * LgTRI$p13.g   + 1/TIn$p111 * LgTRI$d11.13 * d13/LgTRI$sd.13 )
  
  d2l.de2.theta23 <- - respvec$y1.y2.cy3 * ( -1/TIn$p110^2 * d.2 * LgTRI$p.2.10 * LgTRI$d11.23 * LgTRI$p23.g   + 1/TIn$p110 * (LgTRI$d11.23 * (TIn$theta23 * TIn$eta3 - TIn$eta2)/(1 - TIn$theta23^2) * LgTRI$p23.g   - LgTRI$d11.23 * d23/LgTRI$sd.23 * (TIn$theta12 - TIn$theta13 * TIn$theta23)/(1 - TIn$theta23^2) ) ) + 
    respvec$y1.y2.y3 * ( -1/TIn$p111^2 * d.2 * LgTRI$p.2.11 * LgTRI$d11.23 * LgTRI$p23.g   + 1/TIn$p111 * (LgTRI$d11.23 * (TIn$theta23 * TIn$eta3 - TIn$eta2)/(1 - TIn$theta23^2) * LgTRI$p23.g   - LgTRI$d11.23 * d23/LgTRI$sd.23 * (TIn$theta12 - TIn$theta13 * TIn$theta23)/(1 - TIn$theta23^2) ) )
  
  d2l.de3.theta12 <- - respvec$y1.y2.cy3 * ( -1/TIn$p110^2 * d.3 * LgTRI$p.3.11 * LgTRI$d11.12 * LgTRI$p12.g.c + 1/TIn$p110 * LgTRI$d11.12 * d12/LgTRI$sd.12 ) +
    respvec$y1.y2.y3 * ( -1/TIn$p111^2 * d.3 * LgTRI$p.3.11 * LgTRI$d11.12 * LgTRI$p12.g   + 1/TIn$p111 * LgTRI$d11.12 * d12/LgTRI$sd.12 ) 
    
  d2l.de3.theta13 <- - respvec$y1.y2.cy3 * (  1/TIn$p110^2 * d.3 * LgTRI$p.3.11 * LgTRI$d11.13 * LgTRI$p13.g   + 1/TIn$p110 * (LgTRI$d11.13 * ((TIn$theta13 * TIn$eta1 - TIn$eta3)/(1 - TIn$theta13^2)) * LgTRI$p13.g   - LgTRI$d11.13 * (d13/LgTRI$sd.13) * (TIn$theta23 - TIn$theta12 * TIn$theta13)/(1 - TIn$theta13^2) ) ) +
    respvec$y1.y2.y3 * ( -1/TIn$p111^2 * d.3 * LgTRI$p.3.11 * LgTRI$d11.13 * LgTRI$p13.g   + 1/TIn$p111 * (LgTRI$d11.13 * ((TIn$theta13*TIn$eta1 - TIn$eta3)/(1 - TIn$theta13^2)) * LgTRI$p13.g   - LgTRI$d11.13 * (d13/LgTRI$sd.13) * (TIn$theta23 - TIn$theta12 * TIn$theta13)/(1 - TIn$theta13^2) ) ) 
    
  d2l.de3.theta23 <- - respvec$y1.y2.cy3 * (  1/TIn$p110^2 * d.3 * LgTRI$p.3.11 * LgTRI$d11.23 * LgTRI$p23.g   + 1/TIn$p110 * (LgTRI$d11.23 * ((TIn$theta23*TIn$eta2  - TIn$eta3)/(1 - TIn$theta23^2)) * LgTRI$p23.g   - LgTRI$d11.23 * d23/LgTRI$sd.23 * (TIn$theta13 - TIn$theta12*TIn$theta23)/(1 - TIn$theta23^2) ) ) +
    respvec$y1.y2.y3 * ( -1/TIn$p111^2 * d.3 * LgTRI$p.3.11 * LgTRI$d11.23 * LgTRI$p23.g   + 1/TIn$p111 * (LgTRI$d11.23 * ((TIn$theta23*TIn$eta2  - TIn$eta3)/(1 - TIn$theta23^2)) * LgTRI$p23.g   - LgTRI$d11.23 * d23/LgTRI$sd.23 * (TIn$theta13 - TIn$theta12 * TIn$theta23)/(1 - TIn$theta23^2) ) ) 
  ...
  d2l.dtheta12.theta12 <- respvec$y1.cy2 * ( -1/TIn$p10^2  * LgTRI$d11.12^2 - 1/TIn$p10 * dd11.12.dtheta12) + 
    ...
    respvec$y1.y2.y3  * ( -1/TIn$p111^2 * (LgTRI$d11.12 * LgTRI$p12.g   )^2 + 1/TIn$p111 * (( dd11.12.dtheta12 * LgTRI$p12.g  ) - ((d12/LgTRI$sd.12) * (dmean12.dtheta12  + (((TIn$eta3 - LgTRI$mean.12)/(2 * LgTRI$sd.12^2)) * dvar12.dtheta12)) * LgTRI$d11.12) ))
  
  d2l.dtheta13.theta13 <- - respvec$y1.y2.cy3 * (  1/TIn$p110^2 * (LgTRI$d11.13 * LgTRI$p13.g)^2 + 1/TIn$p110 * ((dd11.13.dtheta13 * LgTRI$p13.g  ) - ((d13/LgTRI$sd.13) * (dmean13.dtheta13 + (((TIn$eta2 - LgTRI$mean.13)/(2 * LgTRI$sd.13^2)) * dvar13.dtheta13)) * LgTRI$d11.13) )) + 
    respvec$y1.y2.y3 * ( -1/TIn$p111^2 * (LgTRI$d11.13 * LgTRI$p13.g)^2 + 1/TIn$p111 * (( dd11.13.dtheta13 * LgTRI$p13.g  ) - ((d13/LgTRI$sd.13) * (dmean13.dtheta13 + (((TIn$eta2 - LgTRI$mean.13)/(2 * LgTRI$sd.13^2)) * dvar13.dtheta13)) * LgTRI$d11.13) )) 
  
  d2l.dtheta23.theta23 <- - respvec$y1.y2.cy3 * (  1/TIn$p110^2 * (LgTRI$d11.23 * LgTRI$p23.g   )^2 + 1/TIn$p110 * ((dd11.23.dtheta23 * LgTRI$p23.g  ) - ((d23/LgTRI$sd.23) * (dmean23.dtheta23 + ((TIn$eta1 - LgTRI$mean.23)/(2*LgTRI$sd.23^2) * dvar23.dtheta23)) * LgTRI$d11.23) )) + 
    respvec$y1.y2.y3 * ( -1/TIn$p111^2 * (LgTRI$d11.23 * LgTRI$p23.g   )^2 + 1/TIn$p111 * ((dd11.23.dtheta23 * LgTRI$p23.g  ) - ((d23/LgTRI$sd.23) * (dmean23.dtheta23 + ((TIn$eta1 - LgTRI$mean.23)/(2*LgTRI$sd.23^2) * dvar23.dtheta23)) * LgTRI$d11.23) )) 
    
  d2l.dtheta12.theta13 <- - respvec$y1.y2.cy3 * ( -1/TIn$p110^2 * LgTRI$d11.12 * LgTRI$p12.g.c * LgTRI$d11.13 * LgTRI$p13.g   - 1/TIn$p110 * LgTRI$d11.13 * (d13/LgTRI$sd.13) * (dmean13.dtheta12 + ((TIn$eta2-LgTRI$mean.13)/(2*LgTRI$sd.13^2) * dvar13.dtheta12) )) +
    respvec$y1.y2.y3 * ( -1/TIn$p111^2 * LgTRI$d11.12 * LgTRI$p12.g   * LgTRI$d11.13 * LgTRI$p13.g   - 1/TIn$p111 * LgTRI$d11.13 * (d13/LgTRI$sd.13) * (dmean13.dtheta12 + ((TIn$eta2-LgTRI$mean.13)/(2*LgTRI$sd.13^2) * dvar13.dtheta12) )) 
    
  d2l.dtheta12.theta23 <- - respvec$y1.y2.cy3 * ( -1/TIn$p110^2 * LgTRI$d11.12 * LgTRI$p12.g.c * LgTRI$d11.23 * LgTRI$p23.g   - 1/TIn$p110 * LgTRI$d11.23 * (d23/LgTRI$sd.23) * (dmean23.dtheta12 + ((TIn$eta1-LgTRI$mean.23)/(2*LgTRI$sd.23^2) * dvar23.dtheta12) )) +
    respvec$y1.y2.y3 * ( -1/TIn$p111^2 * LgTRI$d11.12 * LgTRI$p12.g   * LgTRI$d11.23 * LgTRI$p23.g   - 1/TIn$p111 * LgTRI$d11.23 * (d23/LgTRI$sd.23) * (dmean23.dtheta12 + ((TIn$eta1-LgTRI$mean.23)/(2*LgTRI$sd.23^2) * dvar23.dtheta12) )) 
    
  d2l.dtheta13.theta23 <- - respvec$y1.y2.cy3 * (  1/TIn$p110^2 * LgTRI$d11.13 * LgTRI$p13.g   * LgTRI$d11.23 * LgTRI$p23.g   - 1/TIn$p110 * LgTRI$d11.23 * (d23/LgTRI$sd.23) * (dmean23.dtheta13 + ((TIn$eta1-LgTRI$mean.23)/(2 * LgTRI$sd.23^2) * dvar23.dtheta13) )) +
    respvec$y1.y2.y3 * ( -1/TIn$p111^2 * LgTRI$d11.13 * LgTRI$p13.g   * LgTRI$d11.23 * LgTRI$p23.g   - 1/TIn$p111 * LgTRI$d11.23 * (d23/LgTRI$sd.23) * (dmean23.dtheta13 + ((TIn$eta1-LgTRI$mean.23)/(2 * LgTRI$sd.23^2) * dvar23.dtheta13) )) 
