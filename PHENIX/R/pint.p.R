pint.p<-function(traits,n.replicates=1000,N.Pearson=15,plot="Results",tails=1)
{
...
names(out)<-c("Simulated.cor","Simulated.int","Simulated.Range","Simulated.Mean","Real.int","Summary")
