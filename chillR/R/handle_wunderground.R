#' List, download or convert to chillR format data from the Weather Underground
#' airport database
#' 
...
#' 
#' @export handle_wunderground
handle_wunderground<-function(action,location=NA,time_interval=NA,station_list=NULL,stations_to_choose_from=25,drop_most=TRUE,
                              end_at_present=TRUE)
{
