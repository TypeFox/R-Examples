#' Solve a Linear Program (Minimization)
#'
...
#' }
#' 
latteMin <- function(objective, constraints, 
  ...
  ## write code file
  writeLines(consCode, con = file.path2(dir2, "minCode"))
  writeLines(objCode, con = file.path2(dir2, "minCode.cost"))  
  ...
  if(.Platform$OS.type == "unix"){    	
  	# bizarrely, latte-minimize returns its output as stderr
    system(
      paste(
    ...
    matFile <- file.path2(dir2, "minCode 2> out.txt")
