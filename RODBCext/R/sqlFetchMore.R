...
#' @param ... other parametrs passed to \link[RODBC]{sqlFetchMore}
#' @return see \link[RODBC]{sqlFetchMore}
#' @export
sqlFetchMore <- function(channel, ...)
{
  ...
  return(RODBC::sqlFetchMore(channel, ...))
}