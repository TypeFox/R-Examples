...
##  CREATED:   24/07/2009
##
##  FUNCTIONS: NMixPlugCondDensMarg.GLMM_MCMC (24/07/2009)
##             
## ======================================================================
...
## *************************************************************
NMixPlugCondDensMarg.GLMM_MCMC <- function(x, icond, grid, lgrid=50, scaled=FALSE, ...)
{
  ...
  return(NMixPlugCondDensMarg.default(x=grid, icond=icond, scale=scale, w=x$poster.mean.w_b, mu=x$poster.mean.mu_b, Sigma=x$poster.mean.Sigma_b))
}  
