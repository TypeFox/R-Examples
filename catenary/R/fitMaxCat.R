#' Get catenary parameters for given endpoints
#' 
#' Takes endpoints in data frame and returns parameters of 
#' max catenary 
#'
...
fitMaxCat <- function(endpoints){
  ...
  par <- c(c1=tmp$par[1],c2=tmp$par[2],lambda=-tmp$par[1])
  return(par)
}
