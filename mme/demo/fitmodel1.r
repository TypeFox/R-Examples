# THIS IS A COMPLETE EXAMPLE WITH MODEL 1
# USE SIMULATED DATA FOR 50 AREAS AND 1 PERIODS OF TIME
######################
# Model 1
# Model with one random effect in each category of the response variable
######################
...
#Plot direct estimator and model estimator ordered by sample size
dos.ver<-matrix(1:2,1,2)
layout(dos.ver)
...
#PLOT THE RMSE ORDERED BY SAMPLE SIZE
