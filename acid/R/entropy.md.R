entropy.md <-
function(n,alpha=1,dist1,dist2,theta,p0,p1,p2,dist.para.table,zero.approx){
    ...
    entropy <- entropy(y.sim2,alpha=alpha)
    list(entropy=entropy,alpha=alpha,y=y.sim,y2=y.sim2,zero.replace=zero.repl,stat=s.sim)
  }
