...
#' @keywords internal
hrm.2w.2f.AA2 = function(X, alpha, group , subgroup, factor1, factor2, subject, data ){
  ...
  output = data.frame(hypothesis=paste(as.character(group),":",as.character(subgroup)),df1=f,df2=f0, crit=crit, test=test, p.value=p.value, sign.code=.hrm.sigcode(p.value))
