...
#' @keywords internal
hrm.1w.2f.A = function(X, alpha, group , factor1, factor2, subject, data ){
  #Pa - Pd - Pc
  ...
  output = data.frame(hypothesis=paste(as.character(group)),df1=f,df2=f0, crit=crit, test=test, p.value=p.value, sign.code=.hrm.sigcode(p.value))
