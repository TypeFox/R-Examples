...
#
# ALG 9/20/2012: straight copy from rpart.purity.s
#
#
itree.class_purity <- function(y, offset, parms, wt) {
	...
	if (is.null(parms$split)) temp3 <- 1L
		...
		if(temp3==2){
			stop("Invalid 'split' parameter: class purity is only defined for the gini.")
		}
