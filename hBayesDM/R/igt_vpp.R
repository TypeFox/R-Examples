#' Iowa Gambling Task (Worthy et al., 2014)
#' 
#' @description 
  ...
  if (inits[1] != "random") {
    ...
    genInitList <- function() {
      list(
        ...
        mu_epP_pr    = inits_fixed[5],
        mu_epN_pr    = inits_fixed[6],
        mu_K_pr      = qnorm(inits_fixed[7]),
        mu_w_pr      = qnorm(inits_fixed[8]),
        sd_A         = 1,
        sd_alpha     = 1,
        sd_cons      = 1,
        sd_lambda    = 1,
