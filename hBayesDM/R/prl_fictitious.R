#' Probabilistic Reversal Learning Task (Glascher et al, 2009)
#' 
#' @description 
...
#' \describe{
#'  \item{\code{model}}{Character string with the name of the model ("prl_fictitious").}
...
#'  \item{\code{"rewlos"}}{A 1 or -1 for outcome within each given trial (1 = reward, -1 = loss).}
#' } 
