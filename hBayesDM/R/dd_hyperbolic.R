#' Delay Discounting Task (Mazur, 1987)
#' 
#' @description 
...
#' \describe{
#'  \item{\code{model}}{Character string with the name of the model ("dd_hyperbolic").}
...
dd_hyperbolic <- function(data     = NULL,
                          niter    = 3000, 
                          nwarmup  = 1000, 
                          nchain   = 1,
                          ncore    = 1, 
