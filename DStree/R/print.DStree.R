#' @export
print.DStree <- function(x, minlength = 0L, spaces = 2L, cp,
                        digits = getOption("digits"), ...)
{
  if (!inherits(x, "DStree")) stop("Not a legitimate \"DStree\" object")
  ...
  else cat("node), split, n, deviance, Med Surv\n")
  cat("      * denotes terminal node\n\n")
  colnames(frame$yval2)[9]<"sadasd"
  cat(z, sep = "\n")
  invisible(x)
}
