...
#'
#' @description Maps a numeric variable to a 0-1 scale such that high values are
#' desirable.
#'
#' @details Values less than \code{cut1} will have a low desirability. Values
#' greater than \code{cut2} will have a high desirability. Values between
...
#' @seealso \code{\link{d.low}},  \code{\link{d.4pl}}
#' 
#' @examples
#' set.seed(1)
