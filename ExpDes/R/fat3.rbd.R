...
an<-data.frame("DF"=c(glB,gla, glb, glc, glab, glac, glbc, glabc, glE, glT ),
"SS"=c(round(c(SQB,SQa,SQb,SQc,SQab,SQac,SQbc,SQabc,SQE,SQT),5)),
"MS"=c(round(c(QMB,QMa,QMb,QMc,QMab,QMac,QMbc,QMabc,QME,QMT),5)),
