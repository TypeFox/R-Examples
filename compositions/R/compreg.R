...
complm <- function(formula,data,subset,weights,na.action,method="EM",
  ...
  if (method == "model.frame") 
    return(mf)
  else if (method != "qr" && method!="EM" && method!="project") 
  ...
  if (is.empty.model(mt)) {
    ...
    } else if(method == "EM" || TRUE){
      
    } 
  }
  class(z) <- c("complm","mlm", "lm")
