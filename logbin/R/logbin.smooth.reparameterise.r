logbin.smooth.reparameterise <- function(coefficients, interpret, allref, knots, design.knots, design.param,
											subset, na.action) {
	...
	modelspec <- logbin.smooth.design(interpret, dummy.allref, design.knots, dummy.design)
