...
# boosting on set1
res1nu <- try(doSimFDboost(settings=set1))
#res1nu
save(res1nu, file=paste(pathResults, "res1nu.Rdata", sep=""))
...
# boosting on set2
res2nu <- try(doSimFDboost(settings=set2))
#res2nu
save(res2nu, file=paste(pathResults, "res2nu.Rdata", sep=""))
...
# boosting on set3
res3nu <- try(doSimFDboost(settings=set3))
#res3nu
save(res3nu, file=paste(pathResults, "res3nu.Rdata", sep=""))
...
# 
# # boosting on set4
# res4nu <- try(doSimFDboost(settings=set4))
# #res4nu
# save(res4nu, file=paste(pathResults, "res4nu.Rdata", sep=""))
# 
