...
test_that( "Correctness of relative BD (single test function in column matrix form)",
           expect_equal( BD_relative( Data_test_2, Data_ref ), 2/ 3  ) )

test_that( "Correctness of relative BD (single test function in vector form)",
           expect_equal( BD_relative( Data_test_3, Data_ref ), 2/ 3  ) )

test_that( "Correctness of relative BD (single test function in 1D array form)",
           expect_equal( BD_relative( Data_test_4, Data_ref ), 2/ 3  ) )

test_that( "Correctness of relative BD (single test function in row-like 2D array form)",
           expect_equal( BD_relative( Data_test_5, Data_ref ), 2/ 3  ) )

test_that( "Correctness of relative BD (single test function in column-like 2D array form)",
           expect_equal( BD_relative( Data_test_6, Data_ref ), 2/ 3  ) )

test_that( "Correctness of relative BD (multiple test function)",
           expect_equal( BD_relative( Data_test_7, Data_ref ), c( 2/3, 2/3, 0 ) ))
