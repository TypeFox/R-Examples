## based on heatmap.2 of gplot package
#' @importFrom stats density dist hclust median sd order.dendrogram as.dendrogram reorder
#' @importFrom graphics par layout image axis 
#' text strheight strwidth mtext rect abline lines plot plot.new title hist 
#' 
heatmap.3=function (x, Rowv = TRUE, Colv = if (symm) "Rowv" else TRUE, 
    ...
    cexCol = min(0.65, 0.2 + 0.65/log10(nc)), labRow = NULL, labCol = NULL, 
    srtRow = NULL,
    srtCol = NULL,
    adjRow = c(0,NA),
    adjCol = c(NA,0),
    ...
    key = TRUE, keysize = 1.5, density.info = c("histogram", 
        "density", "none"), denscol = tracecol, symkey = max(x < 
