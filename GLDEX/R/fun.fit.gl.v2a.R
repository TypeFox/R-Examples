...
optim.result <- lapply(1:nrow(init.sol), function(i, init.sol, optim.fun2, data, param, breaks, yy)optim(init.sol[i,  ], optim.fun2, data = data, param = param, control = list(maxit = 200000), breaks = breaks, yy = yy), init.sol, optim.fun2, data, param, breaks, yy)
