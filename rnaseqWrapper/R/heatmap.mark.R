                          ...
                          ...) 
{
  ...
  if (length(col) == 1 && is.character(col) && col != "rnaSeqColors") 
  ...
  ## To allow suppressing of layout to enable multiple plots
  if(plotNew){
