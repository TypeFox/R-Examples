...
#
	...
	tkgrid(tklabel(TFrame,text="Fuzzy correspondence analysis", font="Times 18", foreground="red"), labh)
	tkbind(labh, "<Button-1>", function() print(help("dudi.fca")))
	tkgrid(TFrame)
#
# Dataframe and dudi
#
...
################################
	...
	#
		substitute(dudi.fca(df = df, scannf = scannf, nf = nf))
	}
