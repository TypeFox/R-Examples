...
#
	...
	tkgrid(tklabel(TFrame,text="Principal components analysis w/r to orthogonal instrumental variables", font="Times 18", foreground="red"), labh)
	tkbind(labh, "<Button-1>", function() print(help("pcaivortho")))
	tkgrid(TFrame)
#
# Dataframe and dudi
#	
...
################################
	...
	#
		substitute(pcaivortho(dudi = dudi1, df = df2, scannf = scannf, nf = nf))
	}
