...
#
	...
	tkgrid(tklabel(TFrame,text="Convex hulls", font="Times 18", foreground="red"), labh)
	tkbind(labh, "<Button-1>", function() print(help("s.class", package = "adegraphics")))
	tkpack(TFrame)
#
# Coordinates frame
#
...
#
	...
	chull.entry <- tkentry(facframe, textvariable=chullvar, width=10)
	choosechull.but <- tkbutton(facframe, text="Set", command=function() choosechull(chull.entry))
