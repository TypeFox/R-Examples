#' Generates a interval censored clustered dataset using frailty cure rate model
#'
...
#'   standard normal distribution; \code{clus}, representing the cluster id for
#'   each observation.
#' @examples
#' sim_frailty_cl(50)
#' @export
sim_frailty_cl <- function(N, theta = c(-1,1,0),
  ...
  dados <- data.frame(Z, L, R, delta, xi1, xi2, clus)
  return(dados)
}
