"barplotgroupes"=function (cluster, width = 1, space = NULL, names.arg = NULL, 
    ...
    axis.lty = 0, offset = 0, add = FALSE, ...) 
{
    ...
    if (plot) {
        ...
        title(main = "number of individuals by groups", sub = sub, xlab = xlab, ylab = ylab, 
            ...)
        if (axes) 
