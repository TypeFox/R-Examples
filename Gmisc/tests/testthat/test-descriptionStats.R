...
test_that("Check describeMean",{
  ...
  expect_match(describeMean(Loblolly$height_w_missing, html=TRUE, digits=2, useNA="no"),
...
test_that("Check describeMedian",{
  ...
  expect_match(describeMedian(Loblolly$height_w_missing, html=TRUE, digits=2, useNA="no"),
