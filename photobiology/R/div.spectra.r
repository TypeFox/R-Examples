...
#'
#' @param w.length1 numeric array of wavelength (nm) of denominator
#' @param w.length2 numeric array of wavelength (nm) of divisor
#' @param s.irrad1 a numeric array of spectral values of denominator
#' @param s.irrad2 a numeric array of spectral values of divisor
