fat3.ad.dbc <-
function(fator1, fator2, fator3, bloco, resp, respAd, quali=c(TRUE,TRUE,TRUE), mcomp='tukey', fac.names=c('F1','F2','F3'), sigT=0.05, sigF=0.05) {
...
"QM"=c(round(c(QMB,QMa,QMb,QMc,QMab,QMac,QMbc,QMabc,QMad,QME,QMT),5)),
