#' The \code{LR.inter.cont.surv} function performs a Wald test for an interaction term between a continuous variable and a SNP based on a cox model..
#' The function return the pvalue of the Wald test.
#' @export
#' @title Wald test for an interaction term
#' @name LR.inter.cont.surv
...
LR.inter.cont.surv <- function(x,formula,data,Z1){ 
