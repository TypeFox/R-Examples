#-----------------------------------------------------------------------------------#
# Package: camel                                                                    #
# camel.generator(): Data generator                                                 #
# Author: Xingguo Li                                                                #
...
## Main function
camel.tiger.generator <- function(n = 200, d = 50, graph = "random", v = NULL, u = NULL, g = NULL, 
...
print.sim = function(x, ...){
  cat("Simulated data generated by camel.tiger.generator()\n")
