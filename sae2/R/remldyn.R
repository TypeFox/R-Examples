# reml.dyn - restricted maximum likelihood estimation of the multivariate
# dynamic model


reml.dyn <- function(y, X, M, T, NV=1, vcov_e, maxiter=100, iter.tol=.1e-5,
  ...
  fit <- list(model="T: Dynamic, REML", convergence=TRUE)
