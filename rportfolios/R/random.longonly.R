random.longonly <- function(  n=2, k=n, x.t=1, x.l=0, x.u=x.t, max.iter=1000 )
{
###
...
### k = a positive integer value which is the number of non-zero positions
...
###
    if ( k < n ) {
       weights <- random.longonly( n=k, k, x.t, x.l, x.u, max.iter )
