...
###################################################
### code chunk number 16: DE-faithful-optim-print-null
###################################################
opp


###################################################
### code chunk number 17: DE-faithful-optim-print
###################################################
print(opp[names(opp) != "message"])


###################################################
### code chunk number 18: DE-attach-mclust
###################################################
library("mclust")


###################################################
### code chunk number 19: DE-faithful-mclust
###################################################
library("mclust")
...
###################################################
### code chunk number 20: DE-faithful-mclust-mu
###################################################
mc$parameters$mean


###################################################
### code chunk number 21: DE-faithful-mclust-para
###################################################
sqrt(mc$parameters$variance$sigmasq)


###################################################
### code chunk number 22: DE-faithful-flexmix
###################################################
library("flexmix")
...
###################################################
### code chunk number 23: DE-faithful-flexmix-parameters
###################################################
...
###################################################
### code chunk number 24: DE-faithful-2Dplot
###################################################
...
###################################################
### code chunk number 25: DE-faithful-boot
###################################################
library("boot")
fit <- function(x, indx) {
...
###################################################
### code chunk number 26: DE-faithful-bootrun
###################################################
...
###################################################
### code chunk number 27: DE-faithful-p-ci
###################################################
boot.ci(bootpara, type = "bca", index = 1)


###################################################
### code chunk number 28: DE-faithful-mu1-ci
###################################################
boot.ci(bootpara, type = "bca", index = 2)


###################################################
### code chunk number 29: DE-faithful-mu2-ci
###################################################
boot.ci(bootpara, type = "bca", index = 3)


###################################################
### code chunk number 30: DE-bootplot
###################################################
...
###################################################
### code chunk number 31: DE-faithful-boot-plot
###################################################
