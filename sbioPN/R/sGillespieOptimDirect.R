...
sGillespieOptimDirect <- function(model, timep, delta=1, runs=1) {
  storage.mode(runs) <- "integer"
  ...
  .Call("sGillespieOptimDirect", model, timep, delta, runs, place, transition, parent.frame())
}
