...
#' 
#' Plots the ES of a portfolio against confidence level and holding period assuming that P/L is normally distributed, for specified ranges of confidence level and 
#'  holding period.
#' 
