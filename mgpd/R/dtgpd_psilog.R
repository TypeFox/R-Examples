...
if(checkconv)
    ...
    #print(c(param,A1,A2,B1,B2))
    c0       = -1/mupsilog (tx0,ty0,tz0, alpha=alpha, A1=A1, A2=A2, B1=B1, B2=B2)
    dddpsimu = d123mupsilog(tx ,ty ,tz , alpha=alpha, A1=A1, A2=A2, B1=B1, B2=B2)
    Jc       = dtx*dty*dtz
    #c0
    #summary(Jc)
    #summary(dddpsimu)
