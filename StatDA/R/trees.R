...
setClass("Component", representation(LR="numeric",
                                            w="numeric",
                                            h="numeric",
                                            El="numeric",
                                            Bole="numeric"),
                            prototype(LR=0, w=0, h=1, El=0, Bole=2), "VIRTUAL")

setClassUnion("UComponent", c("Component", "NULL"))

setClass("branch", representation(LeafL="UComponent", LeafR="UComponent"),
                   prototype(LeafL=NULL, LeafR=NULL),
                   contains="Component")
