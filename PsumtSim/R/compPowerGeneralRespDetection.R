# 
# Compute power to detect responses differing from background superimposed on 
# a general response.
#
compPowerGeneralRespDetection<-function(bkgLevel, generalRespLevel,
																	respLevel, numCats, numCatsWithResp,
	...
	responseLevels<-c(rep(respLevel,numCatsWithResp),
										 rep(generalRespLevel,numCats-numCatsWithResp))
	numSig<-0
