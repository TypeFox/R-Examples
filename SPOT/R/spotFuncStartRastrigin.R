###################################################################################################
#' Rastrigin function call interface for SPOT, deprecated
#'
#' SPOT uses this function for some demos to call the \code{\link{spotRastriginFunction}} function 
#' 
...
#' \code{\link{spotFuncStartBranin}} \code{\link{spotRastriginFunction}}
#' @keywords internal
###################################################################################################
