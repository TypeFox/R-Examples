...
test.ppam_once_test <- function(){
	sink(file = "/Users/egrant1/Documents/SPRINT/workspace/sprint/trunk/test_suite/ppam_once_results", append = TRUE, type = c("output", "message"),
		 split = FALSE)
