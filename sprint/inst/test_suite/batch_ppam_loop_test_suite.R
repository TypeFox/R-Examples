...
library("sprint")
test.suite <- defineTestSuite("batch", dirs = file.path("/Users/egrant1/Documents/SPRINT/workspace/sprint/trunk/inst/unitTests/batch/"),
	testFileRegexp = 'ppam_loop_test.R')
