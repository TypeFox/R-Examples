...
toMaxDiagNegBinom_n <- function(pars, u, sigmaType, kKi, kLh, kLhi, kY, kX, kZ) {
  ...
  return(qFunctionDiagNegBinomCpp_n(beta = beta, sigma = ovSigma, alpha = alpha, kKi = kKi, u = u, kY = kY, kX = kX, kZ = kZ))
}
