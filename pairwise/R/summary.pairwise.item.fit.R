#' @export summary.pairwise.item.fit
...
#' @param object object of class\code{"pairwise.item.fit", "data.frame" }
...
########################### hier die summary method fuer pairwise.item.fit #############################
summary.pairwise.item.fit<-function(object, sort=FALSE, by="INFIT.ZSTD", decreasing=FALSE, ...){
