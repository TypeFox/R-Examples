print.KPlus1.statis.compromise <- function(x,...){
	
  res.KPlus1.statis.compromise <- x
  if (!inherits(res.KPlus1.statis.compromise, "KPlus1.statis.compromise")) stop ("no convenient data")
  cat("**Results from the analysis of the Compromise via (K+1) STATIS **\n")
