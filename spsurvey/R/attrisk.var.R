...
# Purpose: Calculate values required for estimating variance of the attributable 
#          risk estimate
# Programmer: Tom Kincaid
# Date: November 2, 2010
# Description:
#   This function calculates the variance-covariance estimate for the cell
#   totals used to calculate the attributable risk estimate.  Either
#   the simple random sampling (SRS) variance estimator or the local mean
...
#     variable.  If response.levels equals NULL, then values "Poor" and "Good"
...
#     variable.  If stressor.levels equals NULL, then values "Poor" and "Good"
#     are used for the first level and second level of the stressor variable,
#     respectively.  The default is NULL.
