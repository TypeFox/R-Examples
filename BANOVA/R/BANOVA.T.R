BANOVA.T <-
function(l1_formula = 'NA', l2_formula = 'NA', data, id, l1_hyper = c(1, 1, 1),l2_hyper = c(1,1,0.0001), burnin = 1000, sample = 1000, thin = 2, adapt = 0, conv_speedup = F, jags = runjags.getOption('jagspath')){
