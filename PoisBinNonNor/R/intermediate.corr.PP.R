intermediate.corr.PP<-function(n.P, n.B, n.C, lambda.vec, corr.vec=NULL, corr.mat=NULL){
  ...
  correlation.bound.check(n.P, n.B=0, n.C=0, lambda.vec, prop.vec=NULL, coef.mat=NULL, corr.vec = NULL, corr.mat=cor.mat.P)
