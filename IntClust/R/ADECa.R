 ADECa<-function(List,distmeasure="tanimoto",normalize=FALSE,method=NULL,t=10,r=NULL,nrclusters=NULL,clust="agnes",linkage="ward",alpha=0.625){
	...
	for(g in 1:t){
		...
		Temp=stats::cutree(HClust_A_prime,nrclusters)	
