CategoricalFeaturesPlot<-function(LeadCpds,OrderLab,Features,Data,ColorLab,nrclusters=NULL,cols=NULL,name=c("FP"),colors1=c('gray90','blue',"red"),colors2=c('gray90','green',"gold"),margins=c(5.5,3.5,0.5,5.5),plottype="new",location=NULL){
