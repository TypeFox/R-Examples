...
function(shpFile,shpId,df,dfId,var,var2,
         ...
         title=paste(var,var2,sep=" & "),legendCircles=var,legendDistr=var2,author="author",sources="sources",
...
discretParam<-discretVar(fixBrks=fixBrks,listBrks=listBrks,pt=pt,var=var2,nclass=nclass,
...
# cicles display
symbols(pt[,c("x","y")],circles=pt$varSize,add=TRUE,bg=pt$col,inches=FALSE,lwd=0.5)
