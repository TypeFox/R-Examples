logiway2 = function(x, y, weight, lambda, standardize, epsilon)
{
...
{
aa = .C("anglelogi",as.vector((x.train)),as.vector((Y.matrix)),
...
beta0=beta0.trace,beta=beta.trace,loss="logi",way=2)
#---------------------------------------------#
