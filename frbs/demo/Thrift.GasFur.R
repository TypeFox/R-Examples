...
control <- list(popu.size = 10, num.labels = 5, persen_cross = 0.9, 
                     max.gen = 300, persen_mutant = 0.5, type.defuz = "WAM", type.tnorm = "MIN", 
...
print("Comparison GFS-Thrift Vs Real Value on Gas Furnace Data Set")
print(bench)
...
print("GFS.Thrift: Error Measurement: ")
print(err) 
