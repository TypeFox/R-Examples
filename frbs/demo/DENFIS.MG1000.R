...
control <- list(Dthr= 0.1, max.iter = 300, step.size = 0.01, d = 2, name = "MG1000")
method.type <- "DENFIS"
...
print("Comparison DENFIS Vs Real Value on Mackey Glass Data Set")
print(bench)
...
print("DENFIS: Error Measurement: ")
print(err) 
