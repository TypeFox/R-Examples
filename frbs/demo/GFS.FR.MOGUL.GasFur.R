...
control <- list(persen_cross = 0.9, max.iter = 200, max.gen = 300, 
                max.tune = 300, persen_mutant = 0.3, epsilon = 0.95, name="sim-0")
...
#print("Comparison GFS.FR.MOGUL Vs Real Value on Gas Furnace Data Set")
#print(bench)
