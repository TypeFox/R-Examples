...
wle.weights2 <- function(x, y=NULL, smooth=0.0031, sigma2, raf=1, location=FALSE, max.iter=1000, tol=10^(-6)) {
    ...
    result$density <- w.temp$density
    result$model <- w.temp$model
return(result)
}
